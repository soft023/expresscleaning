...
type PropsWithDefault = "strategy" | "gridSize" | "defaultSize" | "defaultPosition" | "allowOverflow" | "draggable" | "resizable" | "id" | "translations";
...
interface FloatingPanelSchema {
    ...
    tag: "open" | "closed";
    state: "open" | "open.idle" | "open.dragging" | "open.resizing" | "closed";
    event: EventObject;
    action: string;
    effect: string;
    guard: string;
...
export type { AnchorPositionDetails, ElementIds, FloatingPanelApi, FloatingPanelMachine, FloatingPanelProps, FloatingPanelSchema, FloatingPanelService, IntlTranslations, OpenChangeDetails, PositionChangeDetails, ResizeTriggerAxis, ResizeTriggerProps, SizeChangeDetails, Stage, StageChangeDetails, StageTriggerProps };
