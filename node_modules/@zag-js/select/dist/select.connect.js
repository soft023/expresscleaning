...
var select_connect_exports = {};
__export(select_connect_exports, {
  connect: () => connect
});
module.exports = __toCommonJS(select_connect_exports);
var import_dom_query = require("@zag-js/dom-query");
var import_popper = require("@zag-js/popper");
var import_utils = require("@zag-js/utils");
var import_select = require("./select.anatomy.js");
var dom = __toESM(require("./select.dom.js"));
  ...
  return {
    ...
    getRootProps() {
      return normalize.element({
        ...import_select.parts.root.attrs,
        dir: prop("dir"),
    ...
    getLabelProps() {
      return normalize.label({
        ...
        ...import_select.parts.label.attrs,
    ...
    getControlProps() {
      return normalize.element({
        ...import_select.parts.control.attrs,
        dir: prop("dir"),
    ...
    getValueTextProps() {
      return normalize.element({
        ...import_select.parts.valueText.attrs,
        dir: prop("dir"),
        "data-disabled": (0, import_dom_query.dataAttr)(disabled),
        "data-invalid": (0, import_dom_query.dataAttr)(invalid),
        "data-focus": (0, import_dom_query.dataAttr)(focused)
    ...
    getTriggerProps() {
      return normalize.button({
        ...
        ...import_select.parts.trigger.attrs,
        "data-disabled": (0, import_dom_query.dataAttr)(disabled),
        "data-invalid": (0, import_dom_query.dataAttr)(invalid),
        "data-readonly": (0, import_dom_query.dataAttr)(readOnly),
        "data-placement": currentPlacement,
        "data-placeholder-shown": (0, import_dom_query.dataAttr)(!computed("hasSelectedItems")),
        onClick(event) {
        ...
        onKeyDown(event) {
          ...
          if (import_dom_query.getByTypeahead.isValidEvent(event)) {
    ...
    getIndicatorProps() {
      return normalize.element({
        ...import_select.parts.indicator.attrs,
        dir: prop("dir"),
        "aria-hidden": true,
        "data-state": open ? "open" : "closed",
        "data-disabled": (0, import_dom_query.dataAttr)(disabled),
    ...
    getItemProps(props) {
      ...
      return normalize.element({
        ...
        role: "option",
        ...import_select.parts.item.attrs,
        dir: prop("dir"),
    ...
    getItemTextProps(props) {
      const itemState = getItemState(props);
      return normalize.element({
        ...import_select.parts.itemText.attrs,
        "data-state": itemState.selected ? "checked" : "unchecked",
        "data-disabled": (0, import_dom_query.dataAttr)(itemState.disabled),
        "data-highlighted": (0, import_dom_query.dataAttr)(itemState.highlighted)
      });
    ...
    getItemIndicatorProps(props) {
      ...
      return normalize.element({
        "aria-hidden": true,
        ...import_select.parts.itemIndicator.attrs,
        "data-state": itemState.selected ? "checked" : "unchecked",
    ...
    getItemGroupLabelProps(props) {
      const { htmlFor } = props;
      return normalize.element({
        ...import_select.parts.itemGroupLabel.attrs,
    ...
    getItemGroupProps(props) {
      const { id } = props;
      return normalize.element({
        ...import_select.parts.itemGroup.attrs,
        "data-disabled": (0, import_dom_query.dataAttr)(disabled),
    ...
    getClearTriggerProps() {
      return normalize.button({
        ...import_select.parts.clearTrigger.attrs,
    ...
    getHiddenSelectProps() {
      ...
      const handleChange = (e) => {
        const evt = (0, import_dom_query.getNativeEvent)(e);
        if ((0, import_dom_query.isInternalChangeEvent)(evt)) return;
    ...
    getPositionerProps() {
      return normalize.element({
        ...import_select.parts.positioner.attrs,
        dir: prop("dir"),
    ...
    getContentProps() {
      return normalize.element({
        ...
        ...import_select.parts.content.attrs,
        "data-state": open ? "open" : "closed",
        "data-placement": currentPlacement,
        ...
        onKeyDown(event) {
          ...
          if ((0, import_dom_query.isEditableElement)(target)) {
            return;
          }
          if (import_dom_query.getByTypeahead.isValidEvent(event)) {
    ...
    getListProps() {
      return normalize.element({
        ...import_select.parts.list.attrs,
        tabIndex: 0,
