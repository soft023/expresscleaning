...
import { Point, Rect, Size } from './utils/rect.mjs';

type StepEffectCleanup = VoidFunction | void;
...
type StepActionType = "next" | "prev" | "dismiss" | "skip";
