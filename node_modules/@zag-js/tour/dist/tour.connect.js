...
function connect(service, normalize) {
  ...
  const popperStyles = (0, import_popper.getPlacementStyles)({
    strategy: "absolute",
    placement: (0, import_step.isTooltipPlacement)(placement) ? placement : void 0
  });
  const clipPath = (0, import_clip_path.getClipPath)({
    enabled: (0, import_step.isTooltipStep)(step),
    rect: targetRect,
  ...
  return {
    ...
    updateStep(id, stepOverrides) {
      const next = steps.map((step2) => step2.id === id ? (0, import_core.mergeProps)(step2, stepOverrides) : step2);
    ...
    getProgressPercent() {
      const index = (0, import_step.getEffectiveStepIndex)(steps, step?.id);
      const total = (0, import_step.getEffectiveSteps)(steps).length;
    ...
    getBackdropProps() {
      return normalize.element({
        ...import_tour.parts.backdrop.attrs,
        ...
        style: {
          "--tour-layer": 0,
          clipPath: (0, import_step.isTooltipStep)(step) ? `path("${clipPath}")` : void 0,
          position: "absolute",
          inset: "0",
    ...
    getSpotlightProps() {
      return normalize.element({
        ...import_tour.parts.spotlight.attrs,
    ...
    getProgressTextProps() {
      return normalize.element({
        ...import_tour.parts.progressText.attrs
      });
    },
    getPositionerProps() {
      return normalize.element({
        ...import_tour.parts.positioner.attrs,
        dir: prop("dir"),
    ...
    getArrowTipProps() {
      return normalize.element({
        ...import_tour.parts.arrowTip.attrs,
        dir: prop("dir"),
    ...
    getContentProps() {
      return normalize.element({
        ...import_tour.parts.content.attrs,
    ...
    getDescriptionProps() {
      return normalize.element({
        ...import_tour.parts.description.attrs,
    ...
    getCloseTriggerProps() {
      return normalize.element({
        ...import_tour.parts.closeTrigger.attrs,
        "data-type": step?.type,
    ...
    getActionTriggerProps(props) {
      ...
      switch (action) {
        case "next":
          actionProps = {
            ...
            "data-disabled": (0, import_dom_query.dataAttr)(!hasNextStep),
        ...
        case "prev":
          actionProps = {
            ...
            "data-disabled": (0, import_dom_query.dataAttr)(!hasPrevStep),
      ...
      return normalize.button({
        ...import_tour.parts.actionTrigger.attrs,
        type: "button",
        ...attrs,
        ...actionProps
      });
